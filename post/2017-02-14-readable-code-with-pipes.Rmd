...
We will learn a better way of dealing with `lists` while exploring the [purrr](purrr.tidyverse.org) package. The pipe operators work very well 
with the dplyr verbs we will explore in the next post.