...
This is the eighth post in the series **Data Visualisation With R**. In the previous post, we learnt to build histograms. In this post, we will learn how to add a legend to a plot in R.
...
In the next post, we will learn how to add text annotations to a plot
using the `text()` and `mtext()` functions.
