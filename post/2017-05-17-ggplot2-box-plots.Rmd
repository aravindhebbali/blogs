...
This is the 9th post in the series **Elegant Data Visualization with ggplot2**. In the previous [post](https://rsquaredacademy.github.io/blog/post/ggplot2-line-graphs/), we learnt how to build line charts. In this post, we will 
