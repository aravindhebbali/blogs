...
This is the fifth post in the series **Data Wrangling with R**. In the previous [post](https://rsquaredacademy.github.io/blog/post/a-complete-guide-to-importing-data-into-r/), we learnt to import data from flat files, excel spreadsheets and statistical softwares. In this post, we will learn to import data from:
