...
This is the 15th post in the series **Elegant Data Visualization with ggplot2**. In the previos [post](https://rsquaredacademy.github.io/blog/post/legend-part-2/), we learnt how to modify the legend of plots when aesthetics are mapped to variables.If the aesthetics are mapped to variables, ggplot2 automatically creates legends wherever applicable. 
